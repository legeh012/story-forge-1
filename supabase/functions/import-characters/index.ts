...
serve(async (req) => {
  ...
  try {
    ...
    const sayWalahiCharacters = [
      {
        ...
        relationships: { alliances: ["Luul", "Samara"], rivalries: [] },
        status: "active"
      },
      {
        name: "Luul",
        ...
        relationships: { alliances: ["Lucky", "Hani"], rivalries: [] },
        status: "active"
      },
      {
        name: "Samara",
        ...
        relationships: { alliances: ["Lucky", "Ayaan"], rivalries: [] },
        status: "active"
      },
      {
        name: "Ayaan",
        ...
        relationships: { alliances: ["Samara", "Amal"], rivalries: [] },
        status: "active"
      },
      {
        name: "Hani",
        ...
        relationships: { alliances: ["Luul", "Nasra"], rivalries: [] },
        status: "active"
      },
      {
        name: "Zahra",
        ...
        relationships: { alliances: ["Amal", "Nasra"], rivalries: [] },
        status: "active"
      },
      {
        name: "Nasra",
        ...
        relationships: { alliances: ["Hani", "Zahra"], rivalries: [] },
        status: "active"
      },
      {
        name: "Amal",
        ...
        relationships: { alliances: ["Ayaan", "Zahra"], rivalries: [] },
        status: "active"
      }
    ];

    // Use Say Walahi characters if none provided
    const charactersToImport = characters && Array.isArray(characters) && characters.length > 0 
      ? characters 
      : sayWalahiCharacters;
    ...
    console.log(`Importing ${charactersToImport.length} characters for user ${user.id} (Say Walahi cast: ${characters ? 'No' : 'Yes'})`);
